...
where I worked with Prof. [Vijay Chidambaram](http://www.cs.utexas.edu/~vijay/). 
...
from [Hongik University](https://en.hongik.ac.kr/index.do), where I worked with Prof. [Sam H. Noh](https://next.cs.vt.edu/professor/).

# News
* Serving on the program committee for IEEE CLOUD 2026.
